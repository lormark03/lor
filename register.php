...
if(isset($_POST['registerbtn']))
{
    ...
    {
        $query ="INSERT INTO `register` (username,lastname,email,password,usertype) VALUES ('$username',' $lastname',' $email','$password','$usertype')";
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Instructor Rating System</a>
            <!-- Sidebar Toggle-->
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button type="submit" name="registerbtn" class="btn btn-primary btn-user btn-block">
                                                  Register User
                                                 </button></div>
                                            </div>
                                        </form>
